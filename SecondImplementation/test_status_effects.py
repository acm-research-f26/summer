...
def make_dark_flame():
    return PlayerUnit(
        name="DarkFlameInflictor", max_hp=150,
...
def make_self_status():
    return PlayerUnit(
        name="BurnTremorInflictor", max_hp=100,
...
def test_tremor_scorch_skill1_applies_tremor_and_conditional_burst():
    ...
    effect_tremor_scorch_skill1(battle, unit, boss, log)
...
def test_tremor_scorch_skill2_converts_and_double_bursts():
    ...
    effect_tremor_scorch_skill2(battle, unit, boss, log)
...
def test_dark_flame_skill1_uses_current_bullets_then_gains():
    ...
    effect_dark_flame_skill1(battle, unit, boss, log)
...
def test_dark_flame_skill2_gains_then_uses_updated_bullets():
    ...
    effect_dark_flame_skill2(battle, unit, boss, log)
...
def test_self_status_skill1_applies_to_both_self_and_target():
    ...
    effect_self_status_skill1(battle, unit, boss, log)
    assert boss.tremor_potency == 16 and boss.tremor_count == 8
    assert unit.tremor_potency == 5 and unit.tremor_count == 1
...
def test_self_status_skill2_nonlethal_floor_at_1():
    ...
    effect_self_status_skill2(battle, unit, boss, log)
