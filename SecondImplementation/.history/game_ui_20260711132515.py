    ...
    skills = [
        BossSkillDef(
            ...
            description="On hit, inflict 5 tremor potency and 3 tremor count, then trigger "
                        "tremor burst. Damage 15. Rolls 12-15.",
        ...
        BossSkillDef(
            ...
            description="Deal 10 burn potency to target. Base damage 15. Rolls 15-17.",
        ...
        BossSkillDef(
            ...
            description="Targets all enemies. Inflicts 1 tremor count and 1 tremor potency on "
                        ...
                        "tremor scorch. Base damage 30. Rolls 14-15.",
            effect=effect_boss_amplitude_cascade,
        ),
    ]
    return Boss(
        name="Boss", max_hp=1000, skills=skills,
        passive_description="Max HP 1000. Stagger thresholds at 600 and 300. Picks 3 of its "
